...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    outline: "border border-gray-300 text-text bg-transparent hover:bg-gray-50 focus:ring-primary",
    ghost: "text-text bg-transparent hover:bg-gray-100 focus:ring-gray-500"
  };
