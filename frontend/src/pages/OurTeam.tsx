      ...
      <div className="relative bg-gradient-to-br from-[#0F2B48] via-[#163e65] to-[#0a1e33] text-white py-16 px-4 sm:px-6 lg:px-8 overflow-hidden shadow-xl">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight mb-4 text-white">
            Learning Masterclasses & <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 via-sky-200 to-teal-300">Cultural Celebrations</span>
          </h1>

          <p className="max-w-3xl mx-auto text-base sm:text-lg text-gray-300 leading-relaxed">
            Discover life and culture at FAST Careers. From nationwide CA masterclasses and corporate placement summits to grand Diwali celebrations, traditional festivals, innovation hackathons, and annual excellence awards.
          </p>
